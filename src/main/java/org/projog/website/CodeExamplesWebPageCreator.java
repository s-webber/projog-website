...
import static org.projog.website.WebsiteUtils.isPrologScript;
...
final class CodeExamplesWebPageCreator {
   List<CodeExampleWebPage> generate(File prologScriptsDirectory) throws Exception {
      File[] scriptFiles = prologScriptsDirectory.listFiles(new FileFilter() {
         @Override
